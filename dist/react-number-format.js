...
(function (global, factory) {
  ...
  function roundToPrecision(numStr, scale, fixedDecimalScale) {
    ...
    var floatingString = parseFloat("0.".concat(afterDecimal || '0'));
    var roundedDecimalParts = (afterDecimal.length < scale ? floatingString : floatingString.toFixed(scale)).split('.');
